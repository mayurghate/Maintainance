...
def index():
    if request.method == 'POST':
        try:
            ...
            Torque_[Nm] = float(request.form['Torque_[Nm]'])
            ...
            prediction=loaded_model.predict([[Type,Air_temperature_[K],Process_temperature_[K],Rotational_speed_[rpm],Torque_[Nm],Tool_wear_[min],TWF,HDF,PWF,OSF,RNF]])
